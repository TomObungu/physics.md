# Stars with a low mass ( < 10 Solar mass)
...
The core of the red giant will be inert, meaning nuclear fusion will no longer take place since very little hydrogen remains and the temperature is not high enough to for helium nuclei to overcome the electrostatic force. 
...
## Planetary nebula
As time progresses, the layers of the red giant around the core will drift off into space as a planetary nebula leaving behind the hot, inert core as a white dwarf. 
...
The textbook explains that The Pauli exclusion principle states that two electrons cannot exist in the same "energy state". Which is somewhat misleading.
...
This is why there is an arrangement of $2,8\dots$ as the numbers of shells increase - On the second shell there are up to 8 possible distinct quantum mechanical configurations an electron can have without violating Pauli's exclusion principle. 
![[Pasted image 20251101185138.png]]

Watch here: https://www.youtube.com/watch?v=3Gu9TXeNjUo

Therefore when the core of a star begins to collapse under the gravitational force, the electrons are  compressed together and are no longer free to move between energy level due to Pauli's exclusion principle. 

This means the electrons are forced to fill the available energy level. In normal circumstances, the only excited electrons will fill the higher energy levels but in the scenario of inside the core of star, the electrons must occupy higher energy states because there is nowhere else to go. 
